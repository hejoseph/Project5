...
@RestController
public class SafetyAlertControllerCustom {
...
//	@GetMapping("/person3")
//	public List<PersonCustom> personByStations(@RequestParam String[] stations) {
//		return (List<PersonCustom>) personRepository.findByFireStation_StationIn(stations);
//	}
